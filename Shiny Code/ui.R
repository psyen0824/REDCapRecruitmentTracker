...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    br(),
    a('User Manual', href = 'https://github.com/psyen0824/REDCapRecruitmentTracker/blob/main/RShiny%20User%20Manual_20221126.pdf', 
      style = 'margin-left: 10px; font-size: 16px; font-weight: bold; text-decoration: underline; color: white;'),
    br(),
    br(),
    a('Contact us', href = 'https://ccts.uic.edu/services/biostatistics/personnel/', 
      style = 'margin-left: 10px; font-size: 16px; font-weight: bold; text-decoration: underline; color: white;')
  ),
...
# Create Dashboard
dashboardPage(title = 'Recruitment Tracker', header, sidebar, body)